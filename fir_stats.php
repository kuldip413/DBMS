...
<html lang="en">
 ...
 <?php
    ...
    // $email=$var['email'];
// SELECT police_station.police_station, police_inspector.inspector_name, police_inspector.inspector_contact from police_station inner join fir on fir.district=police_station.district and fir.tehsil=police_station.tehsil and fir.town= police_station.town and fir.locality= police_station.locality


    $query="SELECT police_station.police_station, police_station.district , police_station.tehsil , police_station.town ,police_station.locality ,ps_id, count(*) FROM fir inner join police_station on fir.district=police_station.district and fir.tehsil=police_station.tehsil and fir.town= police_station.town and fir.locality= police_station.locality group by police_station.police_station, ps_id order by 2 desc";
