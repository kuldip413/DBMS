...
<html lang="en">
 ...
 <?php
  ...
  $sql = "SELECT image, criminal_id, criminal_name, criminal_identification,criminal_rating FROM criminal ";
          ...
          <table>
            <thead>
              <tr class="table100-head">
                <th class="column1">criminal image</th>
                <th class="column2">criminal id</th>
                <th class="column2">criminal name</th>
                <th class="column1">criminal identification</th>
