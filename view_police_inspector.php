...
<html lang="en">
 ...
 <?php
    ...
    $query="select police_station.ps_id, police_station.police_station, police_inspector.inspector_name from police_inspector inner join police_station on police_station.ps_id=police_inspector.ps_id order by ps_id";
