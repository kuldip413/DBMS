...
if(isset($_POST['submit'])){
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
      ...
      $query1 = "insert into police_station(district, tehsil, town, locality, pin_code, police_station) values ('$district', '$tehsil', '$town', '$locality', '$pin_code', '$police_station')"; 
    
      mysql_select_db("model"); 
      $ans=mysql_query($query1,mysql_connect("localhost","test","test")) or die(mysql_error());
      
      if(!$ans){
        echo "<script type='text/javascript'>alert('Police station Alreday added');</script>";
      }
      else{
          echo "<script type='text/javascript'>alert('Police Station Successfully added');</script>";
     }
