...
<html lang="en">
 ...
 <?php
    ...
    $query="select inspector_name, inspector_contact, username, police_station from police_inspector";
   ...
   if(isset($_POST['submit3']))
    {
...

        {
           ...
           $username = $_POST['username'];
            ...
            $query=mysql_query("DELETE from police_inspector where username= '$username' ",mysql_connect("localhost","test","test"))or die(mysql_error()); 
           if(!$query){
                echo "<script type='text/javascript'>alert('error');</script>";
            }
            else{
                echo "<script type='text/javascript'>alert('Police Inspector Removed');</script>";
            }
...
?>
<head>
   <title>Reomve Police Inspector</title>
  <meta charset="UTF-8">
  <meta name="viewport">
<!--===============================================================================================-->  
...
<div class="topnav">
            <a class="navbar-brand" href="admin_page.php"><b>Back to Home</b></a>
...
<form method="post" style="margin-top: 50px;max-width:800px">
    ...
    <select name="username">
         ...
         <?php
                        $name=mysql_query("select username from police_inspector");
          ...
          <table>
            <thead>
              <tr class="table100-head">
                <th class="column1">Inspector Id</th>
                <th class="column2">Inspector Name</th>
                <th class="column2">Inspector Contact</th>
                <th class="column2">Inspector Police Station</th>
